function createEntityLayer(entities) {
  // debugger;
  return function drawBoundingBoxes(camera, context) {
...
function createTileCandidateLayer(tileCollider) {
  ...
  return function drawTileCandidates(camera, context) {
...
export function createCollisionLayer(level) {
  ...
  return function drawCollision(context, camera) {
    drawBoundingBoxes(camera, context);
    drawTileCandidates(camera, context);
  };
}
